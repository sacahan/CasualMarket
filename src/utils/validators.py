...
def validate_taiwan_stock_symbol(symbol: str) -> bool:
    ...
    - 4位數字：ETF (例如: 0050)
    - 5位數字：ETF (例如: 00922)
    - 6位數字 + 可選字母：ETF、認購權證等 (例如: 00648R, 020000)
    ...
    Examples:
        ...
        True
        >>> validate_taiwan_stock_symbol("0050")
        True
        >>> validate_taiwan_stock_symbol("00922")
        True
        >>> validate_taiwan_stock_symbol("00648R")
        True
